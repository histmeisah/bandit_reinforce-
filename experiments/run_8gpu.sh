#!/bin/bash
# ==============================================================================
# Bandit REINFORCE++ - 8x H100 GPU Runner
# ==============================================================================
set -e
...
# =============================================================================
# CONFIG NAME (default: 8gpu config)
# =============================================================================
CONFIG_NAME="${1:-exp1_bandit_ts_dapo_8gpu}"
...
# 8x H100: use all GPUs
export CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7

# NCCL settings for H100 (enable P2P & IB for best perf)
...
echo "========================================================"
echo " Bandit REINFORCE++ Experiment (8x H100)"
echo "========================================================"
...
# Launch training
# ============================================================
python examples/start_agentic_pipeline.py --config_path "$REL_CONFIG_PATH" --config_name "$CONFIG_NAME" logging_dir="$OUTPUT_DIR/logs" output_dir="$OUTPUT_DIR" checkpoint_config.output_dir="$OUTPUT_DIR/models"
echo ""
echo "========================================================"
